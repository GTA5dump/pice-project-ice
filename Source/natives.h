...
namespace Mod_Hub_Base
{
	...
	namespace TEST
	{
		...
		static char* _GET_VEHICLE_MOD_COLOR_1_TEXT_LABEL(Vehicle vehicle, BOOL p1) { return invoke<char*>(0xB45085B721EFD38C, vehicle, p1); } // 0xB45085B721EFD38C 0x0237C1134582FE45
		static char* _GET_VEHICLE_MOD_COLOR_2_TEXT_LABEL(Vehicle vehicle) { return invoke<char*>(0x4967A516ED23A5A1, vehicle); } // 0x4967A516ED23A5A1 0x85B7E903408ADED3
		typedef void(__fastcall* tSET_VEHICLE_ON_GROUND_PROPERLY)(Vehicle vehicle);
		static void SET_VEHICLE_ON_GROUND_PROPERLY(Vehicle vehicle) { static tSET_VEHICLE_ON_GROUND_PROPERLY oSET_VEHICLE_ON_GROUND_PROPERLY = (tSET_VEHICLE_ON_GROUND_PROPERLY)(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 30 0F 29 74 24 ? 0F 28 F1 E8 ? ? ? ? 48 8B D8").count(1).get(0).get<void>()); return oSET_VEHICLE_ON_GROUND_PROPERLY(vehicle); }
		typedef Vehicle(__fastcall* tCREATE_VEHICLE)(Hash model, Vector3 pos, float heading, BOOL networked, BOOL scriptCheck);
		//static Vehicle CREATE_VEHICLE(Hash model, Vector3 pos, float heading, BOOL networked, BOOL scriptCheck) { static tCREATE_VEHICLE oCREATE_VEHICLE = (tCREATE_VEHICLE)(Memory::pattern("48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC 50 F3 0F 10 02").count(1).get(0).get<void>()); return oCREATE_VEHICLE(model, pos, heading, *g_GameVariables->is_session_started, false); }
	...
	namespace VEHICLE
	{
		...
		static void GET_VEHICLE_NEON_COLOUR(Vehicle vehicle, int* r, int* g, int* b) { invoke<int>(0x7619EEE8C886757F, vehicle, r, g, b); } // 0x7619EEE8C886757F  b323
		static void SET_VEHICLE_NEON_ENABLED(Vehicle vehicle, int index, BOOL toggle) { invoke<int>(0x2AA720E4287BF269, vehicle, index, toggle); } // 0x2AA720E4287BF269  b323
		static BOOL GET_VEHICLE_NEON_ENABLED(Vehicle vehicle, int index) { return invoke<BOOL>(0x8C4B92553E4766A5, vehicle, index); } // 0x8C4B92553E4766A5  b323

		static void SET_VEHICLE_NEON_COLOUR(Vehicle vehicle, int r, int g, int b) { invoke<int>(0x8E0A582209A62695, vehicle, r, g, b); } // 0x8E0A582209A62695  b323
		static void SET_VEHICLE_NEON_INDEX_COLOUR(Vehicle vehicle, int index) { invoke<int>(0xB93B2867F7B479D1, vehicle, index); } // 0xB93B2867F7B479D1  b1493
	...
	namespace GAMEPLAY
	{
		...
		static Ped PlayerPedID() { return invoke<Ped>(0xD80958FC74E988A6); } // 0xD80958FC74E988A6 0xFA92E226
	...
	namespace GRAPHICS
	{
		...
		static void REMOVE_PTFX_ASSET() { invoke<Void>(0x88C6814073DD4A73); } // 0x88C6814073DD4A73 0xC10F178C
		static void REQUEST_NAMED_PTFX_ASSET(const char* assetName) { invoke<Void>(0xB80D8756B4668AB6, assetName); } // 0xB80D8756B4668AB6 0xCFEA19A9
		inline void _DRAW_SPHERE(float x, float y, float z, float radius, int red, int green, int blue, float alpha) { invoke<Void>(0x799017F9E3B10112, x, y, z, radius, red, green, blue, alpha); } // 0x799017F9E3B10112 b463
		...
		static void REQUEST_STREAMED_TEXTURE_DICT(const char* textureDict, BOOL unused) { invoke<Void>(0xDFA2EF8E04127DD5, textureDict, unused); } // 0xDFA2EF8E04127DD5 0x4C9B035F
		static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(const char* textureDict) { return invoke<BOOL>(0x0145F696AAAAD2E4, textureDict); } // 0x0145F696AAAAD2E4 0x3F436EEF
		...
		static void DRAW_RECT2(float x, float y, float width, float height, int r, int g, int b, int a) { invoke<Void>(0x3A618A217E5154F0, x, y, width, height, r, g, b, a); } // 0x3A618A217E5154F0 0xDD2BFC77
		...
		static void DRAW_SPRITE2(const char* textureDict, const char* textureName, float screenX, float screenY, float width, float height, float heading, int red, int green, int blue, int alpha) { invoke<Void>(0xE7FFAE5EBF23D890, textureDict, textureName, screenX, screenY, width, height, heading, red, green, blue, alpha); } // 0xE7FFAE5EBF23D890 0x1FEC16B0
	...
	namespace NETSHOP
	{
		...
		inline void NETWORK_EARN_FROM_ROCKSTAR(int amount) { invoke<Void>(0x02CE1D6AC0FC73EA, amount); } // 0x02CE1D6AC0FC73EA 0x5A37
		...
		inline BOOL _0x86229EFB7FF6B4FC(int* p1, Hash p2, Hash p3, Hash p4, int p5, int p6) { return invoke<BOOL>(0x3C5FD37B5499582E, p1, p2, p3, p4, p5, p6); }
	}
	...
	namespace DLC2
	{
		...
		static void _ON_ENTER_SP() { invoke<Void>(0xD7C10C4A637992C9); } // 0xD7C10C4A637992C9
	}
