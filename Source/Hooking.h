...
namespace Mod_Hub_Base
{
	...
	public:
		...
		static Vehicle create_vehicle(Hash model, Vector3 pos, float heading, BOOL networked, BOOL unk2);
		static Ped create_ped(int pedType, Hash modelHash, float x, float y, float z, float heading, bool isNetworked, bool thisScriptCheck);
		static Object create_object(Hash modelHash, float x, float y, float z, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic);
		static Object create_object(Hash modelHash, Vector3 pos, BOOL isNetwork, BOOL thisScriptCheck, BOOL dynamic);
